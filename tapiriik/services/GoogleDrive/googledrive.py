...
class GoogleDriveService(StorageServiceBase):
    ...
    def _getFile(self, client, path, storageid, cache):
        ...
        try:
            ...
            raise APIException("Error fetching Google Drive file URL - %s" + str(error))
    ...
    def PutFileContents(self, svcRec, client, path, contents, cache):
        ...
        media_body = MediaInMemoryUpload(contents.decode("UTF-8"), mimetype=_MIMETYPES[extn], resumable=True)
