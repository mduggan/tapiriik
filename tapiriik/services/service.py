...
class Service:
    ...
    def List():
        return [RunKeeper, Strava, GarminConnect, SportTracks, GoogleFit, Dropbox, TrainingPeaks, RideWithGPS, Endomondo, Motivato, NikePlus, VeloHero, TrainerRoad, Smashrun] + PRIVATE_SERVICES
    ...
    def PreferredDownloadPriorityList():
        ...
        return [
            ...
            GoogleFit, # no temperature data, supports everything else
