...
class Service:
    ...
    def List():
        return [RunKeeper, Strava, GarminConnect, SportTracks, GoogleFit, Dropbox, TrainingPeaks, RideWithGPS, Endomondo, Motivato, NikePlus, VeloHero, TrainerRoad] + PRIVATE_SERVICES
